...
@Component({
  selector: 'app-crematorium-details',
  templateUrl: './crematorium-details.component.html',
  styleUrls: ['./crematorium-details.component.scss']
})

export class CrematoriumDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sharedService.setTitle('Crematorium Details');
  }
  ...
  backToList() {
    this.router.navigate(['/' + UrlContant.CREMATORIUM_LIST_URL]);
  }
}
